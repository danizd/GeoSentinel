...
| **Antigüedad** | Días transcurridos desde la **fecha del evento** (campo `date`, granularidad día). Un evento de hoy tiene antigüedad 0; la ventana del radar (72 h) cubre hasta 3 días. |
| **Énfasis temporal** | Tratamiento visual de un **evento** según su **antigüedad**: los de hoy se muestran a tamaño y opacidad plenos y por encima de los anteriores; los de días pasados se atenúan progresivamente (menor tamaño, menor opacidad). El color del **distintivo de país** se conserva siempre. |
